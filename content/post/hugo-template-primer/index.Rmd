...
```{r, include=FALSE,  Estimacion Tasa  Mortalidad d  2017}
...
```{r, echo=FALSE  PLOT  Tasas 2017  por sexo y edad }
...
annotate("text", x="Mexico", y=120, label="High Diabetes Rates")+ 
annotate("rect", xmin=17, xmax=32, ymin=0, ymax=131, alpha=.2,fill="pink")+
